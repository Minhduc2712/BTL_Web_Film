...
<head>
    ...
    <title>FilmViet - ${episode.title}</title>
                                    ...
                                    <form id="ratingForm" action="rating" method="post">
                                        <div class="anime__details__rating">
                                            <div class="rating-start">
                                                ...
                                                <input id="episodeIdHidden" name="href" type="hidden"
                                                       value="${episode.href1}">
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="anime__details__btn">
                            ...
                            <c:choose>
                                <c:when test="${movie.price == 0}">
                                    <a
                                            href="<c:url value='/episode?action=watch&id=${episode.href1}'/>"
                                        ...
                                        <c:otherwise>
                                            <c:if test="${not empty sessionScope.currentUser}">
                                                <c:set var="encodedTitle"
                                                       value="${URLEncoder.encode(episode.title, 'UTF-8')}"/>
                    ...
                    <c:forEach items="${comment}" var="cmt">
                        <div class="anime__review__item">
                            <div class="anime__review__item__pic">
                                <img src="views/template/user/img/anime/review-1.jpg" alt="">
                            </div>
                ...
                <div class="anime__details__form">
                    <c:if test="${not empty sessionScope.currentUser}">
                        ...
                        <form action="comment" method="post">
                            ...
                            <input name="href" type="hidden" value="${episode.href1}">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form onsubmit="return disabledButtonOnclickSendEmail()"
                ...
                <input id="episodeIdHidden" name="href" type="hidden"
                       value="${episode.href1}"> <input name="title" type="hidden"
                                                     value="${episode.title}">
            </form>
        </div>
    </div>
...
%>
<script>
    showSwalAlert('success', 'Chia sẽ episode thành công !');
</script>
<%
        }
